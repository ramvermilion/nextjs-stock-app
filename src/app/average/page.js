...
function StockAverageCalculator() {
  ...
  const PurchaseList = () => {
    return purchaseValue.map((item, index) => {
      ...
      return (
        <div
          key={title + index}
          className={`text-sm py-0.5 shadow-md px-2.5 rounded-md flex flex-col justify-between items-center my-1 ${styleClass}`}
        >
  ...
  return (
    <div className="average-main-wrapper">
      <div className="average-container">
        <div className="flex w-11/12 justify-between items-baseline flex-col md:flex-row">
          <div className="flex bg-white	flex-col justify-center border-2 rounded-md p-4 ">
          ...
          <div className="flex flex-col bg-white border-2 rounded-md p-4 mt-5 md:m-0">
